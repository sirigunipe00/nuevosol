...
class AppIcons {
  ...
  static const logo = AppIcon('$imagesPath/logo.jpeg');

  static const mail = AppIcon('$imagesPath/mail.svg');

  static const bubbles = AppIcon('$imagesPath/bubbles.svg');


  static const easycloudLogo = AppIcon('$imagesPath/easycloud 245x132 1.png');
  static const notification = AppIcon('$imagesPath/notification.png');
  ...
  static const loadingConfirmation = AppIcon(
    '$imagesPath/loadingconfirmation.png',
  );
}
