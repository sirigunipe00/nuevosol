...
class DepartmentFilterButton extends StatelessWidget {
  const DepartmentFilterButton({
    super.key,
    required this.selectedDepartmenr,
    required this.onSelect,
    required this.onClear,
  });

  final String? selectedDepartmenr;
  final ValueChanged<String> onSelect;
  final VoidCallback onClear;

  @override
  Widget build(BuildContext context) {
    // final bool isActive = selectedDepartmenr != null;
    final bool isActive =
    selectedDepartmenr != null &&
    selectedDepartmenr!.isNotEmpty;

    return GestureDetector(
      onTap: () {

        context.read<DepartmentCubit>().request();
        _showPicker(context);
      },
      child: AnimatedContainer(
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
              child: Text(
                isActive ? selectedDepartmenr! : 'Department',
                maxLines: 1,
                    ...
                    builder: (context, state) {
                      return state.maybeWhen(
                        success: (items) => Container(
                          ...
                          decoration: BoxDecoration(
                            color: AppColors.registration.withValues(alpha: 0.1),
              ...
              Container(
                ...
                child: TextField(
                  ...
                  onChanged: (val) {
                    ...
                    context.read<DepartmentCubit>().request(val.trim());
                    ...
                    suffixIcon: _searchCtrl.text.isNotEmpty
                        ? GestureDetector(
                            onTap: () {
                              _searchCtrl.clear();
                              setState(() {});
                              context.read<DepartmentCubit>().request(null);
                            },
                            child: Icon(
                              Icons.close_rounded,
                              size: 16,
