...
class _$EmployeeImpl implements _Employee {
  ...
  @override
  String toString() {
    return 'Employee(name: $name, owner: $owner, creation: $creation, modified: $modified, modifiedBy: $modifiedBy, docstatus: $docstatus, idx: $idx, company: $company, employeeName: $employeeName)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, name, owner, creation, modified,
      modifiedBy, docstatus, idx, company, employeeName);
