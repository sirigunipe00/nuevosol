...
import 'package:nuevosol/core/model/page_view_filters_cubit.dart';

class VehicleReportingFilterCubit extends PageViewFiltersCubit {
  VehicleReportingFilterCubit() : super(PageViewFilters.initial());
